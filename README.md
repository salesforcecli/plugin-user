...
_See code: [src/commands/org/assign/permset.ts](https://github.com/salesforcecli/plugin-user/blob/3.6.52/src/commands/org/assign/permset.ts)_
...
_See code: [src/commands/org/assign/permsetlicense.ts](https://github.com/salesforcecli/plugin-user/blob/3.6.52/src/commands/org/assign/permsetlicense.ts)_
...
_See code: [src/commands/org/create/user.ts](https://github.com/salesforcecli/plugin-user/blob/3.6.52/src/commands/org/create/user.ts)_
...
_See code: [src/commands/org/display/user.ts](https://github.com/salesforcecli/plugin-user/blob/3.6.52/src/commands/org/display/user.ts)_
...
_See code: [src/commands/org/generate/password.ts](https://github.com/salesforcecli/plugin-user/blob/3.6.52/src/commands/org/generate/password.ts)_
...
_See code: [src/commands/org/list/users.ts](https://github.com/salesforcecli/plugin-user/blob/3.6.52/src/commands/org/list/users.ts)_
